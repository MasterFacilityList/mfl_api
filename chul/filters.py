...
class CommunityHealthUnitFilter(CommonFieldsFilterset):
    name = django_filters.CharFilter(look_type='icontains')
...
class CommunityHealthWorkerFilter(CommonFieldsFilterset):
    first_name = django_filters.CharFilter(look_type='icontains')
    last_name = django_filters.CharFilter(look_type='icontains')
    username = django_filters.CharFilter(look_type='icontains')
