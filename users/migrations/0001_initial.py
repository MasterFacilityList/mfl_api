    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, blank=True, to='common.County', null=True)),
                ('created_by', models.ForeignKey(related_name='+', default=common.models.get_default_system_user, to=settings.AUTH_USER_MODEL)),
                ('groups', models.ManyToManyField(related_query_name='user', related_name='user_set', to='auth.Group', blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', verbose_name='groups')),
                ('updated_by', models.ForeignKey(related_name='+', default=common.models.get_default_system_user, to=settings.AUTH_USER_MODEL)),
