    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.CharField(help_text=b'The code of the county', max_length=100)),
                ('mfl_code', models.CharField(help_text=b'The MFL code assigned in MFL', max_length=100)),
