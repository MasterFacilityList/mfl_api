...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='facility',
            name='bank_name',
            field=models.CharField(help_text=b"The name of the facility's banker e.g Equity Bank", max_length=100, null=True, blank=True),
        ),
        migrations.AddField(
            model_name='facility',
            name='branch_name',
            field=models.CharField(help_text=b"Branch name of the facility's bank", max_length=100, null=True, blank=True),
        ),
        migrations.AddField(
            model_name='facility',
            name='facility_catchment_population',
            field=models.CharField(help_text=b'The population size which the facility serves', max_length=100, null=True, blank=True),
        ),
        migrations.AddField(
            model_name='facility',
